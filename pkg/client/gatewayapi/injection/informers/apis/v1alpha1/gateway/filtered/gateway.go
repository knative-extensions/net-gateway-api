...
func Get(ctx context.Context, selector string) v1alpha1.GatewayInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/net-gateway-api/pkg/client/gatewayapi/informers/externalversions/apis/v1alpha1.GatewayInformer with selector %s from context.", selector)
	}

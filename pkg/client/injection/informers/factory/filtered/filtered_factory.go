...
import (
	...
	externalversions "knative.dev/net-ingressv2/pkg/client/informers/externalversions"
	client "knative.dev/net-ingressv2/pkg/client/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/net-ingressv2/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}

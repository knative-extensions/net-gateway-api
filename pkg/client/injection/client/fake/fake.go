...
import (
	...
	fake "sigs.k8s.io/gateway-api/pkg/client/clientset/versioned/fake"
)
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch sigs.k8s.io/gateway-api/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
